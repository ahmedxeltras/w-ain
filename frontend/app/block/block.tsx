...
import { AinAiModel } from "@/view/ainai/ainai";
...
import { AinConfigViewModel } from "../view/ainconfig/ainconfig-model";
...
BlockRegistry.set("ainai", AinAiModel);
...
BlockRegistry.set("ainconfig", AinConfigViewModel);
