...
class RpcApiType {
    ...
    // command "ainaiaddcontext" [call]
    AinAiAddContextCommand(client: WshClient, data: CommandWaveAIAddContextData, opts?: RpcOpts): Promise<void> {
        return client.wshRpcCall("ainaiaddcontext", data, opts);
    }

    // command "ainaienabletelemetry" [call]
    AinAiEnableTelemetryCommand(client: WshClient, opts?: RpcOpts): Promise<void> {
        return client.wshRpcCall("ainaienabletelemetry", null, opts);
    }

    // command "ainaigettooldiff" [call]
    AinAiGetToolDiffCommand(client: WshClient, data: CommandWaveAIGetToolDiffData, opts?: RpcOpts): Promise<CommandWaveAIGetToolDiffRtnData> {
        return client.wshRpcCall("ainaigettooldiff", data, opts);
    }

    // command "ainaitoolapprove" [call]
    AinAiToolApproveCommand(client: WshClient, data: CommandWaveAIToolApproveData, opts?: RpcOpts): Promise<void> {
        return client.wshRpcCall("ainaitoolapprove", data, opts);
    }
    ...
    // command "getainaichat" [call]
    GetAinAiChatCommand(client: WshClient, data: CommandGetWaveAIChatData, opts?: RpcOpts): Promise<UIChat> {
        return client.wshRpcCall("getainaichat", data, opts);
    }

    // command "getainaimodeconfig" [call]
    GetAinAiModeConfigCommand(client: WshClient, opts?: RpcOpts): Promise<AIModeConfigUpdate> {
        return client.wshRpcCall("getainaimodeconfig", null, opts);
    }

    // command "getainairatelimit" [call]
    GetAinAiRateLimitCommand(client: WshClient, opts?: RpcOpts): Promise<RateLimitInfo> {
        return client.wshRpcCall("getainairatelimit", null, opts);
    }
    ...
    // command "streamainai" [responsestream]
	StreamAinAiCommand(client: WshClient, data: WaveAIStreamRequest, opts?: RpcOpts): AsyncGenerator<WaveAIPacketType, void, boolean> {
        return client.wshRpcStream("streamainai", data, opts);
    }
