    ...
    getShellIntegrationIconButton(get: jotai.Getter): IconButtonDecl | null {
        ...
        if (shellIntegrationStatus == null) {
            return {
                ...
                title: "No shell integration — Ain AI unable to run commands.",
                noAction: true,
            };
        }
        if (shellIntegrationStatus === "ready") {
            return {
                ...
                title: "Shell ready — Ain AI can run commands in this terminal.",
                noAction: true,
            };
        }
        if (shellIntegrationStatus === "running-command") {
            let title = "Shell busy — Ain AI unable to run commands while another command is running.";
            ...
            if (this.termRef.current) {
                ...
                if (blockingCmd) {
                    title = `Ain AI integration disabled while you're inside ${blockingCmd}.`;
                }
            }
