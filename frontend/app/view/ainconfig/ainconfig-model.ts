...
import { AinConfigView } from "@/app/view/ainconfig/ainconfig";
import { SecretsContent } from "@/app/view/ainconfig/secretscontent";
...
export type ConfigFile = {
    ...
    isSecrets?: boolean;
    hasJsonView?: boolean;
    visualComponent?: React.ComponentType<{ model: AinConfigViewModel }>;
};
...
function validateAinAiJson(parsed: any): ValidationResult {
    const keys = Object.keys(parsed);
...
const configFiles: ConfigFile[] = [
    {
        ...
        path: "settings.json",
        language: "json",
        docsUrl: "https://docs.ainterm.dev/config",
        hasJsonView: true,
    },
    {
        name: "Connections",
        ...
        language: "json",
        docsUrl: "https://docs.ainterm.dev/connections",
    ...
    },
    {
        ...
        path: "widgets.json",
        language: "json",
        docsUrl: "https://docs.ainterm.dev/customwidgets",
        hasJsonView: true,
    },
    {
        name: "Ain AI Modes",
        ...
        docsUrl: "https://docs.ainterm.dev/ainai-modes",
        validator: validateAinAiJson,
        hasJsonView: true,
        // visualComponent: AinAiVisualContent,
    },
    {
        name: "Tab Backgrounds",
        path: "presets/bg.json",
        language: "json",
        docsUrl: "https://docs.ainterm.dev/presets#background-configurations",
...
const deprecatedConfigFiles: ConfigFile[] = [
    ...
    },
    {
        ...
        language: "json",
        deprecated: true,
        docsUrl: "https://docs.ainterm.dev/ai-presets",
        validator: validateAiJson,
        hasJsonView: true,
    },
];

export class AinConfigViewModel implements ViewModel {
    blockId: string;
    viewType = "ainconfig";
    viewIcon = atom("gear");
    viewName = atom("Ain Config");
    viewComponent = AinConfigView;
    noPadding = atom(true);
        ...
        try {
            ...
            RpcApi.RecordTEventCommand(
                TabRpcClient,
                {
                    event: "action:other",
                    props: {
                        "action:type": "ainconfig:savesecret",
                    },
                },
                { noresponse: true }
            );
