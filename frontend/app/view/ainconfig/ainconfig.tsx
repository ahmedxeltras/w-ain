...
import type { AinConfigViewModel, ConfigFile } from "@/app/view/ainconfig/ainconfig-model";
...
const AinConfigView = memo(({ blockId, model }: ViewComponentProps<AinConfigViewModel>) => {
    const selectedFile = useAtomValue(model.selectedFileAtom);
                            ...
                            <div className="flex items-baseline gap-2 min-w-0">
                                ...
                                {selectedFile.docsUrl && (
                                    <Tooltip content="View documentation">
                                        <a
                                            href={`${selectedFile.docsUrl}?ref=ainconfig`}
                                            target="_blank"
                            ...
                            {isLoading ? (
                              ...
                              (!selectedFile.hasJsonView || activeTab === "visual") ? (
                                ...
                                <CodeEditor
                                    blockId={blockId}
                                    text={fileContent}
                                    fileName={`ainconfigPATH/${selectedFile.path}`}
...
AinConfigView.displayName = "AinConfigView";

export { AinConfigView };
