...
const chatConfigs: ChatConfig[] = [
    {
        ...
        markdownResponse: `Here's a quick, file-structure–driven overview of this repo (Ain Term):
...
- **pkg/:** backend packages
  ...
  - \`ainai/\`: AI backends (OpenAI, Anthropic, Google, Perplexity)
...
grep -Ei 'error|panic|fatal|websocket|1006|1011' \\
  "$HOME/Library/Application Support/waveterm-dev/AinApp.log" | tail -n 200

# 2) Inspect around the disconnect window
awk '($0 ~ /2025-10-10 18:08:2[0-9]/){print}' \\
  "$HOME/Library/Application Support/waveterm-dev/AinApp.log"

# 3) Live follow for recurring drops
tail -f "$HOME/Library/Application Support/waveterm-dev/AinApp.log" \\
