...
type FeaturePageName = "ainai" | "magnify" | "files";
...
const AinAiPage = ({ onNext, onSkip }: { onNext: () => void; onSkip: () => void }) => {
    const isMac = isMacOS();
    ...
    return (
        <div className="flex flex-col h-full">
            <header className="flex items-center gap-4 mb-6 w-full unselectable flex-shrink-0">
                ...
                <div className="text-[25px] font-normal text-foreground">Ain AI</div>
            </header>
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-8 pr-6 unselectable">
                    <div className="flex flex-col items-start gap-6 max-w-md">
                        ...
                        <div className="flex flex-col items-start gap-4 text-secondary">
                            <p>
                                Ain AI is your terminal assistant with context. I can read your terminal output, analyze
                            ...
                            <div className="flex items-start gap-3 w-full">
                                ...
                                <p>
                                    Toggle the Ain AI panel with the{" "}
...
export const OnboardingFeatures = ({ onComplete }: { onComplete: () => void }) => {
    const [currentPage, setCurrentPage] = useState<FeaturePageName>("ainai");
    ...
    switch (currentPage) {
        case "ainai":
            pageComp = <AinAiPage onNext={handleNext} onSkip={handleSkip} />;
            break;
        case "magnify":
