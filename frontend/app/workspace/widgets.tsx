...
const Widgets = memo(() => {
    ...
    const featureAinAppBuilder = fullConfig?.settings?.["feature:AinAppbuilder"] ?? false;
    ...
    return (
        <>
            ...
            >
                {mode === "supercompact" ? (
                    <>
                        ...
                        <div className="grid grid-cols-2 gap-0 w-full">
                            {isDev() || featureAinAppBuilder ? (
                                <div
                                    ref={appsButtonRef}
                                    className="flex flex-col justify-center items-center w-full py-1.5 pr-0.5 text-secondary text-sm overflow-hidden rounded-sm hover:bg-hoverbg hover:text-white cursor-pointer"
                                    onClick={() => setIsAppsOpen(!isAppsOpen)}
                                >
                                    <Tooltip content="Local AinApps" placement="left" disable={isAppsOpen}>
                                        <div>
                            ...
                            >
                                <Tooltip content="Settings" placement="left" disable={isSettingsOpen}>
                                    <div>
            ...
            {(isDev() || featureAinAppBuilder) && appsButtonRef.current && (
                <AppsFloatingWindow
                    isOpen={isAppsOpen}
