...
declare global {
    type GlobalAtomsType = {
        ...
        ainAiModeConfigAtom: jotai.PrimitiveAtom<Record<string, AIModeConfigType>>; // resolved AI mode configs -- updated via WebSocket
        ...
        ainAiRateLimitInfoAtom: jotai.PrimitiveAtom<RateLimitInfo>;
    };
    ...
    type ElectronApi = {
        ...
        setWindowInitStatus: (status: "ready" | "ain-ready") => void; // set-window-init-status
        onWaveInit: (callback: (initOpts: AinInitOpts) => void) => void; // wave-init
        ...
        setAinAiOpen: (isOpen: boolean) => void; // set-ainai-open
