...
export class LayoutModel {
     ...
     */
    switchNodeFocusInDirection(direction: NavigateDirection, inainai: boolean): NavigationResult {
        ...
        if (inainai) {
            // For ainai, use a fake position to the left of all nodes
            curNodePos = { left: -10, top: 10, width: 0, height: 0 };

            // Only allow "right" navigation from ainai
