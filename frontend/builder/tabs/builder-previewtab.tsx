            ...
            <div className="flex flex-col items-center gap-6 max-w-[500px] text-center px-8">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-base text-secondary leading-relaxed">
                        Get started by using the AI chat interface on the left to create your AinApp. Describe what you
...
const ErrorStateView = memo(({ errorMsg }: { errorMsg: string }) => {
    ...
    const aiModel = AinAiModel.getInstance();
    ...
    const isStreaming = useAtomValue(aiModel.isAIStreaming);
    ...
    const handleAddToContext = () => {
        ...
        aiModel.appendText(context, true);
        aiModel.focusInput();
    };

    const handleAskAIToFix = async () => {
        const context = getBuildContext();
        aiModel.appendText("Please help me fix this build error:\n\n" + context, true);
        ...
        <div className="w-full h-full flex items-center justify-center bg-background">
            <div className="flex flex-col items-center gap-6 max-w-[500px] text-center px-8">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-base text-secondary leading-relaxed">
                        Your AinApp is being compiled and prepared. This may take a few moments.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div className="w-full h-full flex items-center justify-center bg-background">
            <div className="flex flex-col items-center gap-6 max-w-[500px] text-center px-8">
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-base text-secondary leading-relaxed">
                        Your AinApp is currently not running. Click the button below to start it.
                    </p>
                </div>
                {!isStarting && (
                    <button
