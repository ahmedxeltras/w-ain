...
export const AinAppPathVarName = "AINTERM_APP_PATH";
export const AinAppResourcesPathVarName = "AINTERM_RESOURCES_PATH";
export const AinAppElectronExecPath = "AINTERM_ELECTRONEXECPATH";
