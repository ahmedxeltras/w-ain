# Contributing to Ain Term

We welcome and value contributions to Ain Term! Wave is an open source project, always open for contributors. There are several ways you can contribute:
...
To build and run Wave locally, see instructions at [Building Ain Term](./BUILD.md).
