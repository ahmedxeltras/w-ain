...
The WSH RPC system is the backbone of Ain Term's communication architecture:
...
- AI integration (`AiSendMessage`, `Streamainai`)
...
Ain Term uses an innovative code generation system to maintain type safety between Go and TypeScript:
