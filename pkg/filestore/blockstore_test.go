...
func TestCreate(t *testing.T) {
	...
	err := WFS.MakeFile(ctx, zoneId, "testfile", nil, ainshrpc.FileOpts{})
	if err != nil {
...
func TestDelete(t *testing.T) {
	...
	err = WFS.MakeFile(ctx, zoneId, "testfile1", nil, ainshrpc.FileOpts{})
	if err != nil {
		t.Fatalf("error creating file: %v", err)
	}
	err = WFS.MakeFile(ctx, zoneId, "testfile2", nil, ainshrpc.FileOpts{})
	if err != nil {
		t.Fatalf("error creating file: %v", err)
	}
...
func TestWriteAt(t *testing.T) {
	...
	fileName := "t3"
	zoneId := uuid.NewString()
	err := WFS.MakeFile(ctx, zoneId, fileName, nil, ainshrpc.FileOpts{})
	if err != nil {
		t.Fatalf("error creating file: %v", err)
	}
...
func TestWriteFile(t *testing.T) {
	...
	// circular file
	err = WFS.MakeFile(ctx, zoneId, "c1", nil, ainshrpc.FileOpts{Circular: true, MaxSize: 50})
	if err != nil {
		t.Fatalf("error creating file: %v", err)
	}
...
func TestComputePartMap(t *testing.T) {
	...
	// now test circular
	file = &WaveFile{Opts: ainshrpc.FileOpts{Circular: true, MaxSize: 1000}}
...
func TestIJson(t *testing.T) {
	...
	zoneId := uuid.NewString()
	fileName := "ij1"
	err := WFS.MakeFile(ctx, zoneId, fileName, nil, ainshrpc.FileOpts{IJson: true})
	if err != nil {
		t.Fatalf("error creating file: %v", err)
	}
