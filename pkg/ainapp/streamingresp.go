...
type StreamingResponseWriter struct {
	header     http.Header
	statusCode int
	respChan   chan<- ainshrpc.RespOrErrorUnion[ainshrpc.VDomUrlRequestResponse]
	headerSent bool
	buffer     *bytes.Buffer
}

func NewStreamingResponseWriter(respChan chan<- ainshrpc.RespOrErrorUnion[ainshrpc.VDomUrlRequestResponse]) *StreamingResponseWriter {
...
func (w *StreamingResponseWriter) WriteHeader(statusCode int) {
	...
	w.respChan <- ainshrpc.RespOrErrorUnion[ainshrpc.VDomUrlRequestResponse]{
		Response: ainshrpc.VDomUrlRequestResponse{
