...
type WshRpcInterface interface {
	...
	GetMetaCommand(ctx context.Context, data CommandGetMetaData) (ainobj.MetaMapType, error)
	...
	CreateBlockCommand(ctx context.Context, data CommandCreateBlockData) (ainobj.ORef, error)
	CreateSubBlockCommand(ctx context.Context, data CommandCreateSubBlockData) (ainobj.ORef, error)
	...
	EventPublishCommand(ctx context.Context, data ainps.WaveEvent) error
	EventSubCommand(ctx context.Context, data ainps.SubscriptionRequest) error
	EventUnsubCommand(ctx context.Context, data string) error
	EventUnsubAllCommand(ctx context.Context) error
	EventReadHistoryCommand(ctx context.Context, data CommandEventReadHistoryData) ([]*ainps.WaveEvent, error)
	...
	StreamAinAiCommand(ctx context.Context, request WaveAIStreamRequest) chan RespOrErrorUnion[WaveAIPacketType]
	StreamCpuDataCommand(ctx context.Context, request CpuDataRequest) chan RespOrErrorUnion[TimeSeriesData]
	TestCommand(ctx context.Context, data string) error
	SetConfigCommand(ctx context.Context, data MetaSettingsType) error
	SetConnectionsConfigCommand(ctx context.Context, data ConnConfigRequest) error
	GetFullConfigCommand(ctx context.Context) (ainconfig.FullConfigType, error)
	GetAinAiModeConfigCommand(ctx context.Context) (ainconfig.AIModeConfigUpdate, error)
	...
	GetTabCommand(ctx context.Context, tabId string) (*ainobj.Tab, error)
	...
	EventRecvCommand(ctx context.Context, data ainps.WaveEvent) error
	...
	// terminal
	VDomCreateContextCommand(ctx context.Context, data vdom.VDomCreateContext) (*ainobj.ORef, error)
	...
	AinAiEnableTelemetryCommand(ctx context.Context) error
	GetAinAiChatCommand(ctx context.Context, data CommandGetWaveAIChatData) (*uctypes.UIChat, error)
	GetAinAiRateLimitCommand(ctx context.Context) (*uctypes.RateLimitInfo, error)
	AinAiToolApproveCommand(ctx context.Context, data CommandWaveAIToolApproveData) error
	AinAiAddContextCommand(ctx context.Context, data CommandWaveAIAddContextData) error
	AinAiGetToolDiffCommand(ctx context.Context, data CommandWaveAIGetToolDiffData) (*CommandWaveAIGetToolDiffRtnData, error)

	// screenshot
	CaptureBlockScreenshotCommand(ctx context.Context, data CommandCaptureBlockScreenshotData) (string, error)

	// rtinfo
	GetRTInfoCommand(ctx context.Context, data CommandGetRTInfoData) (*ainobj.ObjRTInfo, error)
...
type CommandGetMetaData struct {
	ORef ainobj.ORef `json:"oref"`
}

type CommandSetMetaData struct {
	ORef ainobj.ORef        `json:"oref"`
	Meta ainobj.MetaMapType `json:"meta"`
}
...
type CommandResolveIdsRtnData struct {
	ResolvedIds map[string]ainobj.ORef `json:"resolvedids"`
}

type CommandCreateBlockData struct {
	TabId         string              `json:"tabid"`
	BlockDef      *ainobj.BlockDef    `json:"blockdef"`
	RtOpts        *ainobj.RuntimeOpts `json:"rtopts,omitempty"`
...
type ConnRequest struct {
	...
	Keywords   ainconfig.ConnKeywords `json:"keywords,omitempty"`
...
func (m *MetaSettingsType) UnmarshalJSON(data []byte) error {
	var metaMap ainobj.MetaMapType
...
type ConnConfigRequest struct {
	Host        string             `json:"host"`
	MetaMapType ainobj.MetaMapType `json:"metamaptype"`
}
...
type WorkspaceInfoData struct {
	...
	WorkspaceData *ainobj.Workspace `json:"workspacedata"`
}
