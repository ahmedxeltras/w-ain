...
const (
	WaveConfigHomeEnvVar           = "AINTERM_CONFIG_HOME"
	WaveDataHomeEnvVar             = "AINTERM_DATA_HOME"
	WaveAppPathVarName             = "AINTERM_APP_PATH"
	WaveAppResourcesPathVarName    = "AINTERM_RESOURCES_PATH"
	WaveAppElectronExecPathVarName = "AINTERM_ELECTRONEXECPATH"
	WaveDevVarName                 = "AINTERM_DEV"
	WaveDevViteVarName             = "AINTERM_DEV_VITE"
	WaveWshForceUpdateVarName      = "AINTERM_WSHFORCEUPDATE"

	WaveJwtTokenVarName  = "AINTERM_JWT"
	WaveSwapTokenVarName = "AINTERM_SWAPTOKEN"
)
...
var ConfigHome_VarCache string          // caches AINTERM_CONFIG_HOME
var DataHome_VarCache string            // caches AINTERM_DATA_HOME
var AppPath_VarCache string             // caches AINTERM_APP_PATH
var AppResourcesPath_VarCache string    // caches AINTERM_RESOURCES_PATH
var AppElectronExecPath_VarCache string // caches AINTERM_ELECTRONEXECPATH
var Dev_VarCache string                 // caches AINTERM_DEV
...
const RemoteWaveHomeDirName = ".ainterm"
const RemoteWshBinDirName = "bin"
const RemoteFullWshBinPath = "~/.ainterm/bin/wsh"
const RemoteFullDomainSocketPath = "~/.ainterm/wave-remote.sock"
