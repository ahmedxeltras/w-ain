...
type MetaTSType struct {
	...
	AinAiPanelOpen     bool   `json:"ainai:panelopen,omitempty"`
	AinAiPanelWidth    int    `json:"ainai:panelwidth,omitempty"`
	AinAiModel         string `json:"ainai:model,omitempty"`
	AinAiChatId        string `json:"ainai:chatid,omitempty"`
	AinAiWidgetContext *bool  `json:"ainai:widgetcontext,omitempty"` // default is true
