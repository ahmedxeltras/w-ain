...
import (
	...
	"github.com/wavetermdev/ainterm/pkg/util/iochan"
...
func TarCopySrc(ctx context.Context, pathPrefix string) (outputChan chan ainshrpc.RespOrErrorUnion[iochantypes.Packet], writeHeader func(fi fs.FileInfo, file string, singleFile bool) error, writer io.Writer, close func()) {
	pipeReader, pipeWriter := io.Pipe()
	tarWriter := tar.NewWriter(pipeWriter)
	rtnChan := iochan.ReaderChan(ctx, pipeReader, ainshrpc.FileChunkSize, func() {
...
func TarCopyDest(ctx context.Context, cancel context.CancelCauseFunc, ch <-chan ainshrpc.RespOrErrorUnion[iochantypes.Packet], readNext func(next *tar.Header, reader *tar.Reader, singleFile bool) error) error {
	pipeReader, pipeWriter := io.Pipe()
