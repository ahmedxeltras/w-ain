...
func GenMethod_Call(buf *strings.Builder, methodDecl *ainshrpc.WshRpcMethodDecl) {
	...
	fmt.Fprintf(buf, "func %s(w *ainshutil.WshRpc%s, opts *ainshrpc.RpcOpts) %s {\n", methodDecl.MethodName, dataType, returnType)
...
func GenMethod_ResponseStream(buf *strings.Builder, methodDecl *ainshrpc.WshRpcMethodDecl) {
	fmt.Fprintf(buf, "// command %q, wshserver.%s\n", methodDecl.Command, methodDecl.MethodName)
	var dataType string
	dataVarName := "nil"
	if methodDecl.CommandDataType != nil {
	...
	fmt.Fprintf(buf, "func %s(w *ainshutil.WshRpc%s, opts *ainshrpc.RpcOpts) chan ainshrpc.RespOrErrorUnion[%s] {\n", methodDecl.MethodName, dataType, respType)
