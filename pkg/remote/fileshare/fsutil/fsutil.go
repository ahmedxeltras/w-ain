...
func PrefixCopyInternal(ctx context.Context, srcConn, destConn *connparse.Connection, c fstype.FileShareClient, opts *ainshrpc.FileCopyOpts, listEntriesPrefix func(ctx context.Context, host string, path string) ([]string, error), copyFunc func(ctx context.Context, host string, path string) error) (bool, error) {
...
func PrefixCopyRemote(ctx context.Context, srcConn, destConn *connparse.Connection, srcClient, destClient fstype.FileShareClient, destPutFile func(host string, path string, size int64, reader io.Reader) error, opts *ainshrpc.FileCopyOpts) (bool, error) {
...
func DetermineCopyDestPath(ctx context.Context, srcConn, destConn *connparse.Connection, srcClient, destClient fstype.FileShareClient, opts *ainshrpc.FileCopyOpts) (srcPath, destPath string, srcInfo *ainshrpc.FileInfo, err error) {
...
func ReadFileStream(ctx context.Context, readCh <-chan ainshrpc.RespOrErrorUnion[ainshrpc.FileData], fileInfoCallback func(finfo ainshrpc.FileInfo), dirCallback func(entries []*ainshrpc.FileInfo) error, fileCallback func(data io.Reader) error) error {
	var fileData *ainshrpc.FileData
	firstPk := true
	isDir := false
	drain := true
	defer func() {
...
func ReadStreamToFileData(ctx context.Context, readCh <-chan ainshrpc.RespOrErrorUnion[ainshrpc.FileData]) (*ainshrpc.FileData, error) {
	var fileData *ainshrpc.FileData
	var dataBuf bytes.Buffer
	var entries []*ainshrpc.FileInfo
	err := ReadFileStream(ctx, readCh, func(finfo ainshrpc.FileInfo) {
		fileData = &ainshrpc.FileData{
			Info: &finfo,
		}
	}, func(fileEntries []*ainshrpc.FileInfo) error {
...
func ReadFileStreamToWriter(ctx context.Context, readCh <-chan ainshrpc.RespOrErrorUnion[ainshrpc.FileData], writer io.Writer) error {
	return ReadFileStream(ctx, readCh, func(finfo ainshrpc.FileInfo) {
	}, func(entries []*ainshrpc.FileInfo) error {
		return nil
	}, func(data io.Reader) error {
