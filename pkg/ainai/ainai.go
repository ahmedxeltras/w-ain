...
func MakeWaveAIPacket() *ainshrpc.WaveAIPacketType {
	return &ainshrpc.WaveAIPacketType{Type: WaveAIPacketstr}
}
...
type AIBackend interface {
	StreamCompletion(
		ctx context.Context,
		request ainshrpc.WaveAIStreamRequest,
	) chan ainshrpc.RespOrErrorUnion[ainshrpc.WaveAIPacketType]
}

func IsCloudAIRequest(opts *ainshrpc.WaveAIOptsType) bool {
	if opts == nil {
		return true
	}
...
func makeAIError(err error) ainshrpc.RespOrErrorUnion[ainshrpc.WaveAIPacketType] {
	return ainshrpc.RespOrErrorUnion[ainshrpc.WaveAIPacketType]{Error: err}
}

func RunAICommand(ctx context.Context, request ainshrpc.WaveAIStreamRequest) chan ainshrpc.RespOrErrorUnion[ainshrpc.WaveAIPacketType] {
	telemetry.GoUpdateActivityWrap(ainshrpc.ActivityUpdate{NumAIReqs: 1}, "RunAICommand")
