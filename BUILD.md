...
These instructions are for setting up dependencies and building Ain Term from source on macOS, Linux, and Windows.
...
Backend logs for the development version of Wave can be found at `~/.ainterm-dev/AinApp.log`. Both the NodeJS backend from Electron and the main Go backend will log here.
