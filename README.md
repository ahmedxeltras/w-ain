<p align="center">
  <a href="https://www.ainterm.dev">
	<picture>
		<source media="(prefers-color-scheme: dark)" srcset="./assets/wave-dark.png">
		<source media="(prefers-color-scheme: light)" srcset="./assets/wave-light.png">
		<img alt="Ain Term Logo" src="./assets/wave-light.png" width="240">
	</picture>
  </a>
  <br/>
</p>
...
Learn more in our [Wave AI documentation](https://docs.ainterm.dev/ainai).

## Installation

Ain Term works on macOS, Linux, and Windows.

Platform-specific installation instructions can be found [here](https://docs.ainterm.dev/gettingstarted).

You can also install Ain Term directly from: [www.ainterm.dev/download](https://www.ainterm.dev/download).

### Minimum requirements

Ain Term runs on the following platforms:
...
- Homepage &mdash; https://www.ainterm.dev
- Download Page &mdash; https://www.ainterm.dev/download
- Documentation &mdash; https://docs.ainterm.dev
- Legacy Documentation &mdash; https://legacydocs.ainterm.dev
- Blog &mdash; https://blog.ainterm.dev
- X &mdash; https://x.com/wavetermdev
- Discord Community &mdash; https://discord.gg/XfvZ334gwU

## Building from Source

See [Building Ain Term](BUILD.md).
...
Ain Term is licensed under the Apache-2.0 License. For more information on our dependencies, see [here](./ACKNOWLEDGEMENTS.md).
