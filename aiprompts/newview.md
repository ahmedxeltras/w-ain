# Creating a New View in Ain Term

This guide explains how to implement a new view type in Ain Term. Views are the core content components displayed within blocks in the terminal interface.

## Architecture Overview

Ain Term uses a **Model-View architecture** where:
