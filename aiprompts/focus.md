# Ain Term Focus System

This document explains how the focus system works in Ain Term, particularly for terminal blocks.

## Overview

Ain Term uses a multi-layered focus system that coordinates between:
