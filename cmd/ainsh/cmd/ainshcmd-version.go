...
func runVersionCmd(cmd *cobra.Command, args []string) error {
	...
	resp, err := wshclient.WaveInfoCommand(RpcClient, &ainshrpc.RpcOpts{Timeout: 2000})
	if err != nil {
		return err
	}

	updateChannel, err := wshclient.GetUpdateChannelCommand(RpcClient, &ainshrpc.RpcOpts{Timeout: 2000, Route: ainshutil.ElectronRoute})
	if err != nil {
		return err
	}
