...
const config: Config = {
    ...
    themeConfig: {
            ...
            items: [
                ...
                !process.env.EMBEDDED
                    ? [
                          {
                              position: "left",
                              href: "https://docs.ainterm.dev/storybook",
                              label: "Storybook",
                          },
                          {
        ...
        metadata: [
            ...
            {
                name: "og:site_name",
                content: "Ain Term Documentation",
            },
            {
