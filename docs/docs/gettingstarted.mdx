...
Ain Term is a modern terminal that includes graphical capabilities like web browsing, file previews, and AI assistance alongside traditional terminal features. This guide will help you get started.
...
You can also download installers directly from our [Downloads page](https://www.ainterm.dev/download).
...
- Configure [Wave AI](./ainai) to use your preferred AI models
