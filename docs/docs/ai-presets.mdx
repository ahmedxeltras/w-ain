...
The AI Widget and its presets are being replaced by [Wave AI](./ainai.mdx). Please refer to the Wave AI documentation for the latest AI features and configuration options.
:::
