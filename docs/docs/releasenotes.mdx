...
- See the new [Wave AI Modes documentation](https://docs.ainterm.dev/ainai-modes) for configuration examples and setup guides
...
- Package updates and dependency upgrades
- WIP: AinApps builder framework (not yet released)
...
- WIP: New AinApps builder framework (not yet released)
...
Ain Term v0.12.0 introduces a completely redesigned AI experience powered by OpenAI GPT-5. This represents a major upgrade and modernization over Wave's previous AI integration, bringing multi-modal support, advanced tool integration, and an intuitive new interface. The main AI PR alone included 128 commits and added 13,000+ lines of code.
...
For more information and upcoming features, visit our [Wave AI documentation](https://docs.ainterm.dev/ainai).
...
* Update AI Libraries, GPT-5 now supported in ainai
...
Ain Term v0.11.1 adds a lot of new functionality over v0.11.0 (it could have almost been a v0.12)!
...
Ain Term v0.11.0 includes a major rewrite of our connections infrastructure, with changes to both our backend and remote file protocol systems, alongside numerous features, bug fixes, and stability improvements.
...
- Global hotkey support [docs](https://docs.ainterm.dev/config#customizable-systemwide-global-hotkey)
- Added configuration to override the font size for markdown, AI-chat, and preview editor [docs](https://docs.ainterm.dev/config)
...
Ain Term v0.10.0 introduces workspaces, making it easier to manage multiple work environments. We've added powerful new command execution capabilities with `wsh run`, allowing you to launch and control commands in dedicated blocks. This release also brings significant improvements to SSH with a new connections configuration system for managing your remote environments.

- **Workspaces**: Organize your work into separate environments, each with their own tabs, layouts, and settings
- **Command Blocks**: New `wsh run` command for launching terminal commands in dedicated blocks, with support for magnification, auto-closing, and execution control ([docs](https://docs.ainterm.dev/wsh-reference#run))
- **Connections**: New configuration system for managing SSH connections, with support for wsh-free operation, per-connection themes, and more ([docs](https://docs.ainterm.dev/connections))
...
- Added Perplexity API integration ([docs](https://docs.ainterm.dev/faq#perplexity))
- `wsh setbg` command for background handling ([docs](https://docs.ainterm.dev/wsh-reference#setbg))
- Switched from Less to SCSS for styling
- [bugfix] Fixed tab flickering issues during tab switches
- [bugfix] Corrected ainai text area resize behavior
...
- Lots of new documentation, including new pages for [Getting Started](https://docs.ainterm.dev/gettingstarted), [AI Presets](https://docs.ainterm.dev/ai-presets), and [wsh overview](https://docs.ainterm.dev/wsh).
- Other bug fixes, performance improvements, and dependency updates
...
- `wsh setvar/getvar` to get and set variables -- [Docs](https://docs.ainterm.dev/wsh-reference#getvarsetvar)
- `wsh file` operations (cat, write, append, rm, info, cp, and ls) -- [Docs](https://docs.ainterm.dev/wsh-reference#file)
...
New minor release with bug fixes and new features! Fixed the bug around making Wave fullscreen (also affecting certain window managers like Hyprland). We've also put a lot of work into the doc site (https://docs.ainterm.dev), including documenting how [Widgets](./widgets) and [Presets](./presets) work!
...
New major Ain Term release! Wave tabs are now cached. Tab switching performance is
...
- added support for Azure AI [See FAQ](https://docs.ainterm.dev/faq#how-can-i-connect-to-azure-ai)
...
- New "help" view -- uses an embedded version of our doc site -- https://docs.ainterm.dev
...
- Use AINTERM_HOME for the home directory consistently
