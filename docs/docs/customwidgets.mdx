...
| "cmd:jwt"              | (optional) A boolean that forces adding JWT token to the environment. Required for running AinApps as widgets (both local and remote). Defaults to false.                                                                                                                        |
