...
| <Kbd k="Cmd:Shift:a"/>                            | Toggle ainai panel visibility                                                                                                                         |
...
| <Kbd k="Ctrl:Shift:0"/>                           | Focus ainai input                                                                                                                                     |
...
| Key                     | Function                |
| ----------------------- | ----------------------- |
| <Kbd k="Cmd:Shift:a"/>  | Toggle ainai panel     |
| <Kbd k="Ctrl:Shift:0" windows="Alt:0"/> | Focus ainai input      |
