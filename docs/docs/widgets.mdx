...
You can use \`wsh view [path]\` from any Ain Term window to open a preview widget with the contents of the specified path (e.g. `wsh view .` or `wsh view ~/myimage.jpg`).
